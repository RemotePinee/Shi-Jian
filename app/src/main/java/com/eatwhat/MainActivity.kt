...
import com.eatwhat.data.repository.*
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val database by lazy { com.eatwhat.data.local.AppDatabase.getDatabase(this) }
