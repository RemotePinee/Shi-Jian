...
- **🎨 视觉美学**：采用大胆的 **Neo-Brutalism** 界面设计，极高对比度、粗边框、鲜亮色彩，打破传统沉闷的 UI 布局。
- **🎤 多模态食材输入**：
    - **文字录入**：手动添加现有食材。
    - **语音识别**：对着手机说话，自动解析食材。
    - **图库/相机识别**：通过拍照或相册选择，快速识别已有食材。
- **🪄 AI 菜谱创作**：基于您提供的食材和选定的菜系，AI 将为您量身定制详细的烹饪步骤、营养分析及饮品建议。
- **🖼️ AI 菜品图鉴**：不仅有文字，还能一键生成极具艺术感的菜品渲染图，让“脑补”化为现实。
- **🧪 酱料设计**：酱料设计功能，为您解决“调料怎么放”的世纪难题。
- **📦 收藏与探索**：保存您的每一次灵感创作，随时回顾“食见”的瞬间。
